 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes * 48.0 * 4.445 + arshins * 16.0 * 4.445 + vershoks * 4.445) / 100
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = sqrt(sqr(abs(x1) - abs(x2)) + sqr(abs(y1) - abs(y2)))
 ...
 */
fun numberRevert(number: Int): Int = number % 10 * 100 + number / 10 % 10 * 10 + number / 10 / 10 % 10
